...
docker run -v "${TEST_APPS_DIR}:/home/codamosa/test-apps" -it --name codamosa-benchmarks-container benchmarks-image  /bin/bash /home/codamosa/scripts/setup_test_apps.sh
